    ...
    <footer className="border-t border-[rgba(0,212,170,0.1)] py-16 px-6 mt-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <div className="relative z-10">
            ...
            <p className="text-[#8899AA] text-lg mb-8 max-w-xl mx-auto">
              Join the future of real estate on Algorand. Verify your property document in seconds — no blockchain experience needed.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-10 mb-12">
          <div>
            ...
            <p className="text-[#8899AA] text-sm leading-relaxed">
              AI-powered real-world asset tokenization on Algorand. Built for the $1.3T Indian real estate market.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-[#8899AA]">
              <li className="hover:text-[#00D4AA] cursor-pointer transition-colors">AI Verification</li>
              <li className="hover:text-[#00D4AA] cursor-pointer transition-colors">Asset Registry</li>
              <li className="hover:text-[#00D4AA] cursor-pointer transition-colors">Roadmap</li>
              <li className="hover:text-[#00D4AA] cursor-pointer transition-colors">Pitch Deck</li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="space-y-3">
              {[
                { label: 'GitHub', href: 'https://github.com/gopichandchalla16', icon: '🐙' },
                { label: 'X / Twitter', href: 'https://x.com/GopichandAI', icon: '🐦' },
                { label: 'LinkedIn', href: 'https://linkedin.com/in/gopichandchalla', icon: '💼' },
                { label: 'Algorand Explorer', href: 'https://testnet.explorer.perawallet.app', icon: '🔗' },
              ].map((link, i) => (
                <a
                  key={i}
                  href={link.href}
        ...
        <div className="border-t border-[rgba(0,212,170,0.1)] pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-[#8899AA]">
          <div>© 2026 ChainVault Protocol · Built by Gopichand Challa · Guntur, India 🇮🇳</div>
          <div className="flex items-center gap-2">
            <div className="w-1.5 h-1.5 rounded-full bg-[#00D4AA] pulse-green"></div>
            <span>Live on Algorand TestNet · Pitch Competition May 21, 2026</span>
          </div>
        </div>
      </div>
    </footer>
